...
public class UsuarioLibroServiceImpl implements IUsuarioLibroService{
	...
	@Override
	public UsuarioLibro buscarUsuarioLibrosByLibroAndUsuario(Integer idLibro, Integer idUsuario) {
		// TODO Auto-generated method stub
		return usuarioLibroRepo.buscarUsuarioLibrosByLibroAndUsuario(idLibro,idUsuario);
	}

	@Override
	public List<UsuarioLibro> buscarUsuarioLibrosByUsuario(Integer idUsuario, Integer idContrato) {
		// TODO Auto-generated method stub
		return usuarioLibroRepo.buscarUsuarioLibrosByUsuario(idUsuario, idContrato);
	}

	@Override
	public List<UsuarioLibro> buscarMisLibros(Integer idUsuario,Integer idEmpresa) {
		// TODO Auto-generated method stub
		return usuarioLibroRepo.buscarMisLibros(idUsuario,idEmpresa);
	}
}
